    ...
    return html`
      <section class="container view">
        <div class="section-heading">
          ...
          <h2>Credito rapido, personalizado y siempre al alcance.</h2>
          <p>
        ...
        <div class="card-grid">
          ${this.renderInfoCard('Atencion cercana', 'Explicamos cada paso con lenguaje claro, sin vueltas y con trato personalizado a tus necesidades.')}
